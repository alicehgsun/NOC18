...
class Vehicle {
  ...
  display() {
    ...
    let healthy = color(255, 255, 0);
    let sick = color(0, 0, 255);
    let col = lerpColor(sick, healthy, this.health)
    ...
    fill(col);
    stroke(col);
    var startRadians = radians(335)+(sin(frameCount*0.1)+100);
    var endRadians = radians(245);
    // var startRadians = radians(315)
    // var endRadians = radians(225);
    arc(0, 0, 20, 20, startRadians, endRadians, PIE);
    pop();
  }
